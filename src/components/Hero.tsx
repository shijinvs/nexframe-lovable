        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              <motion.h1 className="banner-title text-white" variants={itemVariants}>Building Innovative Solutions for Businesses That Think Different.</motion.h1>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
                We empower businesses with cutting-edge ERP systems, mobile & web applications, and digital transformation solutions.
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">ERP Systems</h3>
            <p className="text-gray-600 text-xs md:text-sm">Reliable Frappe and Odoo solutions tailored for your business needs.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Custom Development</h3>
            <p className="text-gray-600 text-xs md:text-sm">Mobile & web applications built with modern technologies and best practices.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <p className="text-gray-600 text-xs md:text-sm">Modernizing legacy systems and streamlining business processes.</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>;
